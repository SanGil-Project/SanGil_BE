...
import com.project.sangil_be.mountain.dto.*;
import com.project.sangil_be.mountain.repository.BookMarkRepository;
import com.project.sangil_be.mountain.repository.CourseRepository;
...
public class MountainService {
    ...
    public Page<SearchDto> searchMountain(String keyword, int pageNum) {
        PageRequest pageRequest = PageRequest.of(pageNum, 15);
